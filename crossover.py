...
class Crossover(object):
    ...
    def crossover(self, population, crossover_probability):
        return self.crossover_algorithm(population, crossover_probability)
...
class BasicCrossover(object):
    ...
    def __call__(self, population, crossover_probability):
        return self.perform_crossover(population, crossover_probability)

    @staticmethod
    def perform_crossover(population, crossover_probability):
    ...
    @staticmethod
    def choose_chromosomes_to_crossover(population, species_not_crossovered, species_to_crossover, crossover_probability):
